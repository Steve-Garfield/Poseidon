...
public class FragCategoryCoffee extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @NonNull ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_category_coffee, container, false);
        ...
        databaseReference = database.getReference().child("Product").child("Coffee"); // DB 테이블연결
    ...
    public static FragCategoryCoffee newInstance() {
        FragCategoryCoffee category_coffee = new FragCategoryCoffee();
