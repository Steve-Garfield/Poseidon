...
public class FragCategoryAll extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @NonNull ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_category_all, container, false);
    ...
    public static FragCategoryAll newInstance() {
        FragCategoryAll category_all = new FragCategoryAll();
        return category_all;
    }
}