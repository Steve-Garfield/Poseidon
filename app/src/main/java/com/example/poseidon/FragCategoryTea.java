...
public class FragCategoryTea extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @NonNull ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_category_tea, container, false);
        ...
        databaseReference = database.getReference().child("Product").child("Tea"); // DB 테이블연결
    ...
    public static FragCategoryTea newInstance() {
        FragCategoryTea category_tea = new FragCategoryTea();
        return category_tea;
    }
}