...
public class FragCategoryEtc extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @NonNull ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_category_etc, container, false);
        ...
        databaseReference = database.getReference().child("Product").child("Etc"); // DB 테이블연결
    ...
    public static FragCategoryEtc newInstance() {
        FragCategoryEtc category_etc = new FragCategoryEtc();
        return category_etc;
    }
}